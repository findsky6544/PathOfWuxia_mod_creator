...
namespace 侠之道mod制作器
{
    public partial class FavorabilityTabControlUserControl : UserControl
    {
        ...
        private void deleteFavorabilityButton_Click(object sender, EventArgs e)
        {
            try
            {
                if (FavorabilityListView.SelectedItems.Count > 0)
                {
                    ...
                    {
                        //写文件
                        string savePath = MainForm.savePath + MainForm.modName + "\\" +DataManager.modTextFilePath + "/Favorability_modify.txt";
                        string content = "";
        ...
        private void openFileToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (FavorabilityListView.SelectedItems.Count > 0 && FavorabilityListView.SelectedItems[0].SubItems[FavorabilityListView.SelectedItems[0].SubItems.Count - 1].Text == "1" && File.Exists(MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "Favorability_modify.txt"))
            {
                filePath = MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "Favorability_modify.txt";
            }
