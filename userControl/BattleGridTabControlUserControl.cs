...
namespace 侠之道mod制作器
{
    public partial class BattleGridTabControlUserControl : UserControl
    {
        ...
        private void openFileToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (BattleGridListView.SelectedItems.Count > 0 && BattleGridListView.SelectedItems[0].SubItems[BattleGridListView.SelectedItems[0].SubItems.Count - 1].Text == "1" && File.Exists(MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "BattleGrid.txt"))
            {
                filePath = MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "BattleGrid.txt";
            }
