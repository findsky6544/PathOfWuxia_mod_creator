...
namespace 侠之道mod制作器
{
    public partial class GameFormulaTabControlUserControl : UserControl
    {
        ...
        private void deleteGameFormulaButton_Click(object sender, EventArgs e)
        {
            try
            {
                if (GameFormulaListView.SelectedItems.Count > 0)
                {
                    ...
                    {
                        //写文件
                        string savePath = MainForm.savePath + MainForm.modName + "\\" +DataManager.modTextFilePath + "/GameFormula_modify.txt";
                        string content = "";
        ...
        private void openFileToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (GameFormulaListView.SelectedItems.Count > 0 && GameFormulaListView.SelectedItems[0].SubItems[GameFormulaListView.SelectedItems[0].SubItems.Count - 1].Text == "1" && File.Exists(MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "GameFormula_modify.txt"))
            {
                filePath = MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "GameFormula_modify.txt";
            }
