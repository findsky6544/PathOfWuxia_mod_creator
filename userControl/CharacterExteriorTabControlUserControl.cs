...
namespace 侠之道mod制作器
{
    public partial class CharacterExteriorTabControlUserControl : UserControl
    {
        ...
        private void openFileToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (CharacterExteriorListView.SelectedItems.Count > 0 && CharacterExteriorListView.SelectedItems[0].SubItems[CharacterExteriorListView.SelectedItems[0].SubItems.Count - 1].Text == "1" && File.Exists(MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "CharacterExterior_modify.txt"))
            {
                filePath = MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "CharacterExterior_modify.txt";
            }
