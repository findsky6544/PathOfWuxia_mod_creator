...
namespace 侠之道mod制作器
{
    public partial class EvaluationTabControlUserControl : UserControl
    {
        ...
        private void openFileToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (EvaluationListView.SelectedItems.Count > 0 && EvaluationListView.SelectedItems[0].SubItems[EvaluationListView.SelectedItems[0].SubItems.Count - 1].Text == "1" && File.Exists(MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "Evaluation.txt"))
            {
                filePath = MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "Evaluation.txt";
            }
