...
namespace 侠之道mod制作器
{
    public partial class ElectiveTabControlUserControl : UserControl
    {
        ...
        private void deleteElectiveButton_Click(object sender, EventArgs e)
        {
            try
            {
                if (ElectiveListView.SelectedItems.Count > 0)
                {
                    ...
                    {
                        //写文件
                        string savePath = MainForm.savePath + MainForm.modName + "\\" +DataManager.modTextFilePath + "/Elective.txt";
                        string content = "";
        ...
        private void openFileToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (ElectiveListView.SelectedItems.Count > 0 && ElectiveListView.SelectedItems[0].SubItems[ElectiveListView.SelectedItems[0].SubItems.Count - 1].Text == "1" && File.Exists(MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "Elective.txt"))
            {
                filePath = MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "Elective.txt";
            }
