...
namespace 侠之道mod制作器
{
    public partial class PropsTabControlUserControl : UserControl
    {
        ...
        private void openFileToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (PropsListView.SelectedItems.Count > 0 && PropsListView.SelectedItems[0].SubItems[PropsListView.SelectedItems[0].SubItems.Count - 1].Text == "1" && File.Exists(MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "Props_modify.txt"))
            {
                filePath = MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "Props_modify.txt";
            }
