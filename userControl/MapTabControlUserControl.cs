...
namespace 侠之道mod制作器
{
    public partial class MapTabControlUserControl : UserControl
    {
        ...
        private void openFileToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (MapListView.SelectedItems.Count > 0 && MapListView.SelectedItems[0].SubItems[MapListView.SelectedItems[0].SubItems.Count - 1].Text == "1" && File.Exists(MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "Map.txt"))
            {
                filePath = MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "Map.txt";
            }
