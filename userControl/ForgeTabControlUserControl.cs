...
namespace 侠之道mod制作器
{
    public partial class ForgeTabControlUserControl : UserControl
    {
        ...
        private void openFileToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (ForgeListView.SelectedItems.Count > 0 && ForgeListView.SelectedItems[0].SubItems[ForgeListView.SelectedItems[0].SubItems.Count - 1].Text == "1" && File.Exists(MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "Forge_modify.txt"))
            {
                filePath = MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "Forge_modify.txt";
            }
