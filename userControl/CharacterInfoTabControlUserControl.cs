...
namespace 侠之道mod制作器
{
    public partial class CharacterInfoTabControlUserControl : UserControl
    {
        ...
        private void deleteCharacterInfoButton_Click(object sender, EventArgs e)
        {
            try
            {
                if (CharacterInfoListView.SelectedItems.Count > 0)
                {
                    ...
                    {
                        //写文件
                        string savePath = MainForm.savePath + MainForm.modName + "\\" +DataManager.modTextFilePath + "/CharacterInfo.txt";
                        string content = "";
        ...
        private void openFileToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (CharacterInfoListView.SelectedItems.Count > 0 && CharacterInfoListView.SelectedItems[0].SubItems[CharacterInfoListView.SelectedItems[0].SubItems.Count - 1].Text == "1" && File.Exists(MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "CharacterInfo.txt"))
            {
                filePath = MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "CharacterInfo.txt";
            }
