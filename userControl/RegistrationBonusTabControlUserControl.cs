...
namespace 侠之道mod制作器
{
    public partial class RegistrationBonusTabControlUserControl : UserControl
    {
        ...
        private void openFileToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (RegistrationBonusListView.SelectedItems.Count > 0 && RegistrationBonusListView.SelectedItems[0].SubItems[RegistrationBonusListView.SelectedItems[0].SubItems.Count - 1].Text == "1" && File.Exists(MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "RegistrationBonus.txt"))
            {
                filePath = MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "RegistrationBonus.txt";
            }
