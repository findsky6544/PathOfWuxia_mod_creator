...
namespace 侠之道mod制作器
{
    public partial class HelpTabControlUserControl : UserControl
    {
        ...
        private void deleteHelpButton_Click(object sender, EventArgs e)
        {
            try
            {
                if (HelpListView.SelectedItems.Count > 0)
                {
                    ...
                    {
                        //写文件
                        string savePath = MainForm.savePath + MainForm.modName + "\\" +DataManager.modTextFilePath + "/Help_modify.txt";
                        string content = "";
        ...
        private void openFileToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (HelpListView.SelectedItems.Count > 0 && HelpListView.SelectedItems[0].SubItems[HelpListView.SelectedItems[0].SubItems.Count - 1].Text == "1" && File.Exists(MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "Help_modify.txt"))
            {
                filePath = MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "Help_modify.txt";
            }
