...
namespace 侠之道mod制作器
{
    public partial class BattleEventCubeTabControlUserControl : UserControl
    {
        ...
        private void openFileToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (BattleEventCubeListView.SelectedItems.Count > 0 && BattleEventCubeListView.SelectedItems[0].SubItems[BattleEventCubeListView.SelectedItems[0].SubItems.Count - 1].Text == "1" && File.Exists(MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "BattleEventCube_modify.txt"))
            {
                filePath = MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "BattleEventCube_modify.txt";
            }
