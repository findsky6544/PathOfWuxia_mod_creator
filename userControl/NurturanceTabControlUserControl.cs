...
namespace 侠之道mod制作器
{
    public partial class NurturanceTabControlUserControl : UserControl
    {
        ...
        private void openFileToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (NurturanceListView.SelectedItems.Count > 0 && NurturanceListView.SelectedItems[0].SubItems[NurturanceListView.SelectedItems[0].SubItems.Count - 1].Text == "1" && File.Exists(MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "Nurturance.txt"))
            {
                filePath = MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "Nurturance.txt";
            }
