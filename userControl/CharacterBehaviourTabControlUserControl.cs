...
namespace 侠之道mod制作器
{
    public partial class CharacterBehaviourTabControlUserControl : UserControl
    {
        ...
        private void deleteCharacterBehaviourButton_Click(object sender, EventArgs e)
        {
            try
            {
                if (CharacterBehaviourListView.SelectedItems.Count > 0)
                {
                    ...
                    {
                        //写文件
                        string savePath = MainForm.savePath + MainForm.modName + "\\" +DataManager.modTextFilePath + "/CharacterBehaviour.txt";
                        string content = "";
        ...
        private void openFileToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (CharacterBehaviourListView.SelectedItems.Count > 0 && CharacterBehaviourListView.SelectedItems[0].SubItems[CharacterBehaviourListView.SelectedItems[0].SubItems.Count - 1].Text == "1" && File.Exists(MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "CharacterBehaviour.txt"))
            {
                filePath = MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "CharacterBehaviour.txt";
            }
