...
namespace 侠之道mod制作器
{
    public partial class EventCubeTabControlUserControl : UserControl
    {
        ...
        private void openFileToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (EventCubeListView.SelectedItems.Count > 0 && EventCubeListView.SelectedItems[0].SubItems[EventCubeListView.SelectedItems[0].SubItems.Count - 1].Text == "1" && File.Exists(MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "EventCube.txt"))
            {
                filePath = MainForm.savePath + MainForm.modName + "\\" + DataManager.modTextFilePath + "\\" + "EventCube.txt";
            }
