...
namespace 侠之道mod制作器
{
    public partial class CheckPlayerTotalUpgradablePropertyForm : Form
    {
        public bool isAdd;
        public TreeNode currentNode;
        public CheckPlayerTotalUpgradablePropertyForm()
        {
            InitializeComponent();

            initOpComboBox();
        }
        public CheckPlayerTotalUpgradablePropertyForm(TreeNode currentNode, bool isAdd) : this()
        {
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"CheckPlayerTotalUpgradableProperty\" : " + ((ComboBoxItem)opComboBox.SelectedItem).key + ", " + valueNumericUpDown.Text;
