...
namespace 侠之道mod制作器
{
    public partial class CheckCurrentTimeForm : Form
    {
        public bool isAdd;
        public TreeNode currentNode;
        public CheckCurrentTimeForm()
        {
            InitializeComponent();

            initTimeComboBox();
        }
        public CheckCurrentTimeForm(TreeNode currentNode, bool isAdd) : this()
        {
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"CheckCurrentTime\" : " + ((ComboBoxItem)timeComboBox.SelectedItem).key;
