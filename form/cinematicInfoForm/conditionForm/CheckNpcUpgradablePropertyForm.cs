...
namespace 侠之道mod制作器
{
    public partial class CheckNpcUpgradablePropertyForm : Form
    {
        public bool isAdd;
        public TreeNode currentNode;
        public CheckNpcUpgradablePropertyForm()
        {
            InitializeComponent();
        ...
        public CheckNpcUpgradablePropertyForm(TreeNode currentNode, bool isAdd) : this()
        {
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"CheckNpcUpgradableProperty\" : " + ((ComboBoxItem)opComboBox.SelectedItem).key + ", " + valueNumericUpDown.Text + ", " + ((ComboBoxItem)propertyComboBox.SelectedItem).key + ", \"" + npcIdTextBox.Text + "\"";
