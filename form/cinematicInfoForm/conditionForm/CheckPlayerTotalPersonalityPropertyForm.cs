...
namespace 侠之道mod制作器
{
    public partial class CheckPlayerTotalPersonalityPropertyForm : Form
    {
        public bool isAdd;
        public TreeNode currentNode;
        public CheckPlayerTotalPersonalityPropertyForm()
        {
            InitializeComponent();

            initOpComboBox();
        }
        public CheckPlayerTotalPersonalityPropertyForm(TreeNode currentNode, bool isAdd) : this()
        {
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"CheckPlayerTotalPersonalityProperty\" : " + ((ComboBoxItem)opComboBox.SelectedItem).key + ", " + valueNumericUpDown.Text;
