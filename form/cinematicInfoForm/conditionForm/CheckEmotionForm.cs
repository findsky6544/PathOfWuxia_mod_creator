...
namespace 侠之道mod制作器
{
    public partial class CheckEmotionForm : Form
    {
        public bool isAdd;
        public TreeNode currentNode;
        public CheckEmotionForm()
        {
            InitializeComponent();

            initOpComboBox();
        }
        public CheckEmotionForm(TreeNode currentNode, bool isAdd) : this()
        {
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"CheckEmotion\" : " + ((ComboBoxItem)opComboBox.SelectedItem).key + ", " + valueNumericUpDown.Text;
