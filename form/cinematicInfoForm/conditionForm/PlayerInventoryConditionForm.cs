...
namespace 侠之道mod制作器
{
    public partial class PlayerInventoryConditionForm : Form
    {
        public bool isAdd;
        public TreeNode currentNode;
        public PlayerInventoryConditionForm()
        {
            InitializeComponent();

            initOpComboBox();
        }
        public PlayerInventoryConditionForm(TreeNode currentNode, bool isAdd) : this()
        {
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"PlayerInventoryCondition\" : " + ((ComboBoxItem)opComboBox.SelectedItem).key + ", " + valueNumericUpDown.Text + ", \"" + idTextBox.Text + "\"";
            currentNode.Text = Text + ":" + DataManager.getPropssName(idTextBox.Text) + " 的数量 " + opComboBox.Text + " " + valueNumericUpDown.Text;
