...
namespace 侠之道mod制作器
{
    public partial class CheckPlayerPropertyForm : Form
    {
        public bool isAdd;
        public TreeNode currentNode;
        public CheckPlayerPropertyForm()
        {
            InitializeComponent();
        ...
        public CheckPlayerPropertyForm(TreeNode currentNode, bool isAdd) : this()
        {
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"CheckPlayerProperty\" : " + ((ComboBoxItem)opComboBox.SelectedItem).key + ", " + valueNumericUpDown.Text + ", " + ((ComboBoxItem)propertyComboBox.SelectedItem).key;
