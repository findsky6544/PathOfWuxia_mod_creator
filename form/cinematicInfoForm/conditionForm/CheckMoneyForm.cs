...
namespace 侠之道mod制作器
{
    public partial class CheckMoneyForm : Form
    {
        public bool isAdd;
        public TreeNode currentNode;
        public CheckMoneyForm()
        {
            InitializeComponent();

            initOpComboBox();
        }
        public CheckMoneyForm(TreeNode currentNode, bool isAdd) : this()
        {
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"CheckMoney\" : " + ((ComboBoxItem)opComboBox.SelectedItem).key + ", " + valueNumericUpDown.Text;
