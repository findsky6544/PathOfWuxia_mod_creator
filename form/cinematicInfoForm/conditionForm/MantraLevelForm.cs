...
namespace 侠之道mod制作器
{
    public partial class MantraLevelForm : Form
    {
        public bool isAdd;
        public TreeNode currentNode;
        public MantraLevelForm()
        {
            InitializeComponent();

            initOpComboBox();
        }
        public MantraLevelForm(TreeNode currentNode, bool isAdd) : this()
        {
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"MantraLevel\" : " + ((ComboBoxItem)opComboBox.SelectedItem).key + ", " + valueNumericUpDown.Text;
