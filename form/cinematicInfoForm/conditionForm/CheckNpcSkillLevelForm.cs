...
namespace 侠之道mod制作器
{
    public partial class CheckNpcSkillLevelForm : Form
    {
        public bool isAdd;
        public TreeNode currentNode;
        public CheckNpcSkillLevelForm()
        {
            InitializeComponent();

            initOpComboBox();
        }
        public CheckNpcSkillLevelForm(TreeNode currentNode, bool isAdd) : this()
        {
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"CheckNpcSkillLevel\" : " + ((ComboBoxItem)opComboBox.SelectedItem).key + ", " + valueNumericUpDown.Text + ", \"" + Skill_IdTextBox.Text + "\", \"" + npcIdTextBox.Text + "\"";
            currentNode.Text = Text + ":" + DataManager.getCharacterExteriorName(npcIdTextBox.Text) + " 的 " + DataManager.getSkillsName(Skill_IdTextBox.Text) + " 的等级 " + opComboBox.Text + " " + valueNumericUpDown.Text;
