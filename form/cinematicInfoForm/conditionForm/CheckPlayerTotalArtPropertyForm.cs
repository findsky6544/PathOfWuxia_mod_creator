...
namespace 侠之道mod制作器
{
    public partial class CheckPlayerTotalArtPropertyForm : Form
    {
        public bool isAdd;
        public TreeNode currentNode;
        public CheckPlayerTotalArtPropertyForm()
        {
            InitializeComponent();

            initOpComboBox();
        }
        public CheckPlayerTotalArtPropertyForm(TreeNode currentNode, bool isAdd) : this()
        {
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"CheckPlayerTotalArtProperty\" : " + ((ComboBoxItem)opComboBox.SelectedItem).key + ", " + valueNumericUpDown.Text;
