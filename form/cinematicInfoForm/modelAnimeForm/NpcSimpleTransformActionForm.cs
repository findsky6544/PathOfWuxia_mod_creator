...
namespace 侠之道mod制作器
{
    public partial class NpcSimpleTransformActionForm : Form
    {
        public bool isAdd;
        public object obj;
        public NpcSimpleTransformActionForm()
        {
            InitializeComponent();
        }
        public NpcSimpleTransformActionForm(object obj, bool isAdd) : this()
        {
            this.obj = obj;
            this.isAdd = isAdd;
            ...
            if (!string.IsNullOrEmpty(fields))
            {
                ...
                npcIdTextBox.Text = fieldsList[9].Trim();
            }
        }
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            string tag = "\"NpcSimpleTransformAction\" : " + isMoveCheckBox.Checked + ", " + positionTextBox.Text + ", " + durationNumericUpDown.Text + "," + isRotateCheckBox.Checked + ", " + rotationTextBox.Text + ", \"" + npcIdTextBox.Text + "\"";
            string text = Text + ":" + DataManager.getNpcsName(npcIdTextBox.Text) + " " + (isMoveCheckBox.Checked ? ("用 " + durationNumericUpDown.Text + " 秒移动至 " + positionTextBox.Text) : "不移动") + ";然后 " + (isRotateCheckBox.Checked ? ("旋转至 " + rotationTextBox.Text) : "不旋转");
