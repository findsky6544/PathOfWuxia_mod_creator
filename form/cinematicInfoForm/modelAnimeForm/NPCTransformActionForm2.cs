...
namespace 侠之道mod制作器
{
    public partial class NPCTransformActionForm2 : Form
    {
        public bool isAdd;
        public object obj;
        public NPCTransformActionForm2()
        {
            InitializeComponent();
        }
        public NPCTransformActionForm2(object obj, bool isAdd) : this()
        {
            this.obj = obj;
            this.isAdd = isAdd;
            ...
            if (!string.IsNullOrEmpty(fields))
            {
                ...
                npcIdTextBox.Text = fieldsList[10].Trim();
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            string tag = "\"NPCTransformAction\" : " + isMoveCheckBox.Checked + ", " + positionTextBox.Text + ", " + moveDurationNumericUpDown.Text + "," + isRotateCheckBox.Checked + ", " + rotationTextBox.Text + ", " + rotateDurationNumericUpDown.Text + ", \"" + npcIdTextBox.Text + "\"";
            string text = Text + ":" + DataManager.getNpcsName(npcIdTextBox.Text) + " " + (isMoveCheckBox.Checked ? moveDurationNumericUpDown.Text + " 秒移动到 " + positionTextBox.Text : "不移动") + ";" + (isRotateCheckBox.Checked ? rotateDurationNumericUpDown.Text + " 秒旋转到 " + rotationTextBox.Text : "不旋转");
