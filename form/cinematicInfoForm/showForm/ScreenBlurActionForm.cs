...
namespace 侠之道mod制作器
{
    public partial class ScreenBlurActionForm : Form
    {
        public bool isAdd;
        public object obj;
        public ScreenBlurActionForm()
        {
            InitializeComponent();
        }
        public ScreenBlurActionForm(object obj, bool isAdd) : this()
        {
            this.obj = obj;
            this.isAdd = isAdd;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            string tag = "\"ScreenBlurAction\" : " + isFadeInCheckBox.Checked + ", " + durationNumericUpDown.Text;
