...
namespace 侠之道mod制作器
{
    public partial class CameraLockNpcActionForm : Form
    {
        public bool isAdd;
        public object obj;
        public CameraLockNpcActionForm()
        {
            InitializeComponent();
        }
        public CameraLockNpcActionForm(object obj, bool isAdd) : this()
        {
            this.obj = obj;
            this.isAdd = isAdd;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            string tag = "\"CameraLockNpcAction\" : " + "\"" + npcIdTextBox.Text + "\"";
