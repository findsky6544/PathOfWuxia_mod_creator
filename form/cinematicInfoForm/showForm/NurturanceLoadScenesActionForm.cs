...
namespace 侠之道mod制作器
{
    public partial class NurturanceLoadScenesActionForm : Form
    {
        public bool isAdd;
        public object obj;
        public NurturanceLoadScenesActionForm()
        {
            InitializeComponent();
        ...
        public NurturanceLoadScenesActionForm(object obj, bool isAdd) : this()
        {
            this.obj = obj;
            this.isAdd = isAdd;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            string tag = "\"NurturanceLoadScenesAction\" : " + "\"" + mapIdTextBox.Text + "\"" + ", " + positionTextBox.Text + ", " + rotationTextBox.Text + ", " + ((ComboBoxItem)loadTypeComboBox.SelectedItem).key + ", " + isNextTimeCheckBox.Checked + ", " + ((ComboBoxItem)timeStageComboBox.SelectedItem).key;
            string text = Text + ":" + "场景:" + DataManager.getMapsName(mapIdTextBox.Text) + " 玩家位置:" + positionTextBox.Text + "  玩家方向:" + rotationTextBox.Text + " 载入类型:" + loadTypeComboBox.Text + " " + (isNextTimeCheckBox.Checked ? "" : "不") + "切换日夜" + " 切换阶段:" + timeStageComboBox.Text;
