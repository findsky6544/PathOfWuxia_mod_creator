...
namespace 侠之道mod制作器
{
    public partial class ScreenFadeActionForm : Form
    {
        public bool isAdd;
        public object obj;
        public ScreenFadeActionForm()
        {
            InitializeComponent();
        }
        public ScreenFadeActionForm(object obj, bool isAdd) : this()
        {
            this.obj = obj;
            this.isAdd = isAdd;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            string tag = "\"ScreenFadeAction\" : " + isFadeInCheckBox.Checked + ", " + durationNumericUpDown.Text;
