...
namespace 侠之道mod制作器
{
    public partial class RunCinematicActionForm : Form
    {
        public bool isAdd;
        public object obj;
        public RunCinematicActionForm()
        {
            InitializeComponent();
        }
        public RunCinematicActionForm(object obj, bool isAdd) : this()
        {
            this.obj = obj;
            this.isAdd = isAdd;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            string tag = "\"RunCinematicAction\" : " + "\"" + idTextBox.Text + "\"";
