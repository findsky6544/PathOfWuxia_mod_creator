...
namespace 侠之道mod制作器
{
    public partial class SetPlayerUpgradablePropertyForm : Form
    {
        public bool isAdd;
        public object obj;
        public SetPlayerUpgradablePropertyForm()
        {
            InitializeComponent();
        ...
        public SetPlayerUpgradablePropertyForm(object obj, bool isAdd) : this()
        {
            this.obj = obj;
            this.isAdd = isAdd;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            string tag = "\"SetPlayerUpgradableProperty\" : " + ((ComboBoxItem)methodComboBox.SelectedItem).key + ", " + valueNumericUpDown.Text + ", " + ((ComboBoxItem)propertyComboBox.SelectedItem).key;
            string text = Text + ":" + propertyComboBox.Text + " " + methodComboBox.Text + (((ComboBoxItem)methodComboBox.SelectedItem).key == ((int)Method.Clear).ToString() ? "" : " " + (valueNumericUpDown.Value / 100));
