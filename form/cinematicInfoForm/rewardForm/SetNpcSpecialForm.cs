...
namespace 侠之道mod制作器
{
    public partial class SetNpcSpecialForm : Form
    {
        public bool isAdd;
        public object obj;
        public SetNpcSpecialForm()
        {
            InitializeComponent();

            initMethodComboBox();
        }
        public SetNpcSpecialForm(object obj, bool isAdd) : this()
        {
            this.obj = obj;
            this.isAdd = isAdd;
            ...
            if (!string.IsNullOrEmpty(fields))
            {
                ...
                specialIdTextBox.Text = fieldsList[1].Trim();
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            if (specialIdTextBox.Text == "")
            {
                MessageBox.Show("请输入特技编号");
                return;
            }
            ...
            string tag = "\"SetNpcSpecial\" : " + ((ComboBoxItem)methodComboBox.SelectedItem).key + ", " + "\"" + specialIdTextBox.Text + "\"" + ", " + "\"" + npcIdTextBox.Text + "\"";
            ...
            string text = Text + ":" + DataManager.getCharacterInfoRemark(npcIdTextBox.Text) + " " + methodStr + " " + DataManager.getSkillsName(specialIdTextBox.Text);
        ...
        {
            SelectSkillForm form = new SelectSkillForm(this, specialIdTextBox, false, SelectSkillForm.selectSkillType.special);
            form.ShowDialog();
        }
