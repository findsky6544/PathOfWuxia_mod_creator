...
namespace 侠之道mod制作器
{
    public partial class SetPlayerMantraEXPForm : Form
    {
        public bool isAdd;
        public object obj;
        public SetPlayerMantraEXPForm()
        {
            InitializeComponent();

            initMethodComboBox();
        }
        public SetPlayerMantraEXPForm(object obj, bool isAdd) : this()
        {
            this.obj = obj;
            this.isAdd = isAdd;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            string tag = "\"SetPlayerMantraEXP\" : " + ((ComboBoxItem)methodComboBox.SelectedItem).key + ", " + valueNumericUpDown.Text + ", " + "\"" + mantraIdTextBox.Text + "\"";
            string text = Text + ":" + DataManager.getMantraName(mantraIdTextBox.Text) + " 的经验" + " " + methodComboBox.Text + (((ComboBoxItem)methodComboBox.SelectedItem).key == ((int)Method.Clear).ToString() ? "" : (" " + valueNumericUpDown.Text));
