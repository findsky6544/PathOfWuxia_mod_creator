...
namespace 侠之道mod制作器
{
    public partial class SetPlayerSkillForm : Form
    {
        public bool isAdd;
        public object obj;
        public SetPlayerSkillForm()
        {
            InitializeComponent();

            initMethodComboBox();
        }
        public SetPlayerSkillForm(object obj, bool isAdd) : this()
        {
            this.obj = obj;
            this.isAdd = isAdd;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            string tag = "\"SetPlayerSkill\" : " + ((ComboBoxItem)methodComboBox.SelectedItem).key + ", " + "\"" + SkillIdTextBox.Text + "\"";
            ...
            string text = Text + ":" + methodStr + DataManager.getSkillsName(SkillIdTextBox.Text);
