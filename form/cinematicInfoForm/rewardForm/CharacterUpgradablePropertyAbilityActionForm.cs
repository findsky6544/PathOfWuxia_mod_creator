...
namespace 侠之道mod制作器
{
    public partial class CharacterUpgradablePropertyAbilityActionForm : Form
    {
        public bool isAdd;
        public object obj;
        public CharacterUpgradablePropertyAbilityActionForm()
        {
            InitializeComponent();
        ...
        public CharacterUpgradablePropertyAbilityActionForm(object obj, bool isAdd) : this()
        {
            this.obj = obj;
            this.isAdd = isAdd;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            string tag = "\"CharacterUpgradablePropertyAbilityAction\" : " + ((ComboBoxItem)methodComboBox.SelectedItem).key + ", " + valueNumericUpDown.Text + ", " + ((ComboBoxItem)propertyComboBox.SelectedItem).key;
