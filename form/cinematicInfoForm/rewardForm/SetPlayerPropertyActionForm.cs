...
namespace 侠之道mod制作器
{
    public partial class SetPlayerPropertyActionForm : Form
    {
        public bool isAdd;
        public object obj;
        public SetPlayerPropertyActionForm()
        {
            InitializeComponent();
        ...
        public SetPlayerPropertyActionForm(object obj, bool isAdd) : this()
        {
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            string tag = "\"SetPlayerPropertyAction\" : " + ((ComboBoxItem)methodComboBox.SelectedItem).key + ", " + valueNumericUpDown.Text + ", " + ((ComboBoxItem)propertyComboBox.SelectedItem).key;
