...
namespace 侠之道mod制作器
{
    public partial class SetNpcTraitForm : Form
    {
        public bool isAdd;
        public object obj;
        public SetNpcTraitForm()
        {
            InitializeComponent();

            initMethodComboBox();
        }
        public SetNpcTraitForm(object obj, bool isAdd) : this()
        {
            this.obj = obj;
            this.isAdd = isAdd;
            ...
            if (!string.IsNullOrEmpty(fields))
            {
                ...
                traitIdTextBox.Text = fieldsList[1].Trim();
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            string tag = "\"SetNpcTrait\" : " + ((ComboBoxItem)methodComboBox.SelectedItem).key + ", " + "\"" + traitIdTextBox.Text + "\"" + ", " + "\"" + npcIdTextBox.Text + "\"";
            ...
            string text = Text + ":" + DataManager.getCharacterInfoRemark(npcIdTextBox.Text) + " " + methodStr + " " + DataManager.getTraitName(traitIdTextBox.Text);
        ...
        {
            SelectTraitForm form = new SelectTraitForm(this, traitIdTextBox, false);
            form.ShowDialog();
        }
