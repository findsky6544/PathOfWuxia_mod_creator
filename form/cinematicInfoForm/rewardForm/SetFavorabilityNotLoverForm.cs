...
namespace 侠之道mod制作器
{
    public partial class SetFavorabilityNotLoverForm : Form
    {
        public bool isAdd;
        public object obj;
        public SetFavorabilityNotLoverForm()
        {
            InitializeComponent();
        }
        public SetFavorabilityNotLoverForm(object obj, bool isAdd) : this()
        {
            this.obj = obj;
            this.isAdd = isAdd;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            string tag = "\"SetFavorabilityNotLover\" : " + "\"" + idTextBox.Text + "\"";
