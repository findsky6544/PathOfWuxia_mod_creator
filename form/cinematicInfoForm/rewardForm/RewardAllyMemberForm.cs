...
namespace 侠之道mod制作器
{
    public partial class RewardAllyMemberForm : Form
    {
        public bool isAdd;
        public object obj;
        public RewardAllyMemberForm()
        {
            InitializeComponent();

            initMethodComboBox();
        }
        public RewardAllyMemberForm(object obj, bool isAdd) : this()
        {
            this.obj = obj;
            this.isAdd = isAdd;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("请输入盟友编号");
                return;
            }

            string tag = "\"RewardAllyMember\" : " + ((ComboBoxItem)methodComboBox.SelectedItem).key + ", " + "\"" + memberidTextBox.Text + "\"";
            string text = "";
            ...
            text = Text + ":" + DataManager.getNpcsName(memberidTextBox.Text) + " " + text;
