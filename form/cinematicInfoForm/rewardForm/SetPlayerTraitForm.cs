...
namespace 侠之道mod制作器
{
    public partial class SetPlayerTraitForm : Form
    {
        public bool isAdd;
        public object obj;
        public SetPlayerTraitForm()
        {
            InitializeComponent();

            initMethodComboBox();
        }
        public SetPlayerTraitForm(object obj, bool isAdd) : this()
        {
            this.obj = obj;
            this.isAdd = isAdd;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            string tag = "\"SetPlayerTrait\" : " + ((ComboBoxItem)methodComboBox.SelectedItem).key + ", " + "\"" + traitIdTextBox.Text + "\"";
            ...
            string text = Text + ":" + methodStr + DataManager.getTraitName(traitIdTextBox.Text);
