...
namespace 侠之道mod制作器
{
    public partial class SetNpcUpgradablePropertyForm : Form
    {
        public bool isAdd;
        public object obj;
        public SetNpcUpgradablePropertyForm()
        {
            InitializeComponent();
        ...
        public SetNpcUpgradablePropertyForm(object obj, bool isAdd) : this()
        {
            this.obj = obj;
            this.isAdd = isAdd;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            string tag = "\"SetNpcUpgradableProperty\" : " + ((ComboBoxItem)methodComboBox.SelectedItem).key + ", " + valueNumericUpDown.Text + ", " + ((ComboBoxItem)propertyComboBox.SelectedItem).key + ", " + "\"" + npcIdTextBox.Text + "\"";
            string text = Text + ":" + DataManager.getCharacterInfoRemark(npcIdTextBox.Text) + " 的 " + propertyComboBox.Text + " " + methodComboBox.Text + (((ComboBoxItem)methodComboBox.SelectedItem).key == ((int)Method.Clear).ToString() ? "" : " " + (valueNumericUpDown.Value / 100));
