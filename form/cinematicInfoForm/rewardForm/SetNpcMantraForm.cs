...
namespace 侠之道mod制作器
{
    public partial class SetNpcMantraForm : Form
    {
        public bool isAdd;
        public object obj;
        public SetNpcMantraForm()
        {
            InitializeComponent();

            initMethodComboBox();
        }
        public SetNpcMantraForm(object obj, bool isAdd) : this()
        {
            this.obj = obj;
            this.isAdd = isAdd;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            string tag = "\"SetNpcMantra\" : " + ((ComboBoxItem)methodComboBox.SelectedItem).key + ", " + "\"" + mantraIdTextBox.Text + "\"" + ", " + "\"" + npcIdTextBox.Text + "\"";
            ...
            string text = Text + ":" + DataManager.getCharacterInfoRemark(npcIdTextBox.Text) + " " + methodStr + " " + DataManager.getMantraName(mantraIdTextBox.Text);
