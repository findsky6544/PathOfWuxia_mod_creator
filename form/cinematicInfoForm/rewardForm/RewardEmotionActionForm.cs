...
namespace 侠之道mod制作器
{
    public partial class RewardEmotionActionForm : Form
    {
        public bool isAdd;
        public object obj;
        public RewardEmotionActionForm()
        {
            InitializeComponent();

            initMethodComboBox();
        }
        public RewardEmotionActionForm(object obj, bool isAdd) : this()
        {
            this.obj = obj;
            this.isAdd = isAdd;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            string tag = "\"RewardEmotionAction\" : " + ((ComboBoxItem)methodComboBox.SelectedItem).key + ", " + valueNumericUpDown.Text;
