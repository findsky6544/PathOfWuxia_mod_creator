...
namespace 侠之道mod制作器
{
    public partial class SetPlayerSpecialForm : Form
    {
        public bool isAdd;
        public object obj;
        public SetPlayerSpecialForm()
        {
            InitializeComponent();

            initMethodComboBox();
        }
        public SetPlayerSpecialForm(object obj, bool isAdd) : this()
        {
            this.obj = obj;
            this.isAdd = isAdd;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            string tag = "\"SetPlayerSpecial\" : " + ((ComboBoxItem)methodComboBox.SelectedItem).key + ", " + "\"" + specialIdTextBox.Text + "\"";
            ...
            string text = Text + ":" + methodStr + DataManager.getSkillsName(specialIdTextBox.Text);
