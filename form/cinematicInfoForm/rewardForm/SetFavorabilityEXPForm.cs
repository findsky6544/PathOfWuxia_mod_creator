...
namespace 侠之道mod制作器
{
    public partial class SetFavorabilityEXPForm : Form
    {
        public bool isAdd;
        public object obj;
        public SetFavorabilityEXPForm()
        {
            InitializeComponent();

            initMethodComboBox();
        }
        public SetFavorabilityEXPForm(object obj, bool isAdd) : this()
        {
            this.obj = obj;
            this.isAdd = isAdd;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            string tag = "\"SetFavorabilityEXP\" : " + ((ComboBoxItem)methodComboBox.SelectedItem).key + ", " + valueNumericUpDown.Text + ", " + "\"" + idTextBox.Text + "\"";
            string text = Text + ":" + DataManager.getNpcsName(idTextBox.Text) + " 好感度" + " " + methodComboBox.Text + " " + valueNumericUpDown.Text;
