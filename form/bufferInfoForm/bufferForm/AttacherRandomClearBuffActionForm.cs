...
namespace 侠之道mod制作器
{
    public partial class AttacherRandomClearBuffActionForm : Form
    {
        public bool isAdd;
        public AttacherRandomClearBuffActionForm()
        {
            InitializeComponent();

            initOrientedComboBox();
        }
        public AttacherRandomClearBuffActionForm(string tag, bool isAdd, Form owner) : this()
        {
            Owner = owner;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(countNumericUpDown.Text))
            {
            ...
            currentNode.Tag = "\"AttacherRandomClearBuffAction\" : " + ((ComboBoxItem)orientedComboBox.SelectedItem).key + ", " + countNumericUpDown.Value;

            currentNode.Text = "随机清除自身Buff:" + orientedComboBox.Text + " " + countNumericUpDown.Value + " 个";
            Close();
        }
