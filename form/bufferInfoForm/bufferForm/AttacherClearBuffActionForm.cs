...
namespace 侠之道mod制作器
{
    public partial class AttacherClearBuffActionForm : Form
    {
        public bool isAdd;
        public AttacherClearBuffActionForm()
        {
            InitializeComponent();
        }
        public AttacherClearBuffActionForm(string tag, bool isAdd, Form owner) : this()
        {
            Owner = owner;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"AttacherClearBuffAction\" : \"" + bufferIdTextBox.Text + "\"";
            currentNode.Text = "指定清除自身Buff: " + DataManager.getBuffersName(bufferIdTextBox.Text);
            Close();
        }
