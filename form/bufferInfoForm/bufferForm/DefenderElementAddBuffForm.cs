...
namespace 侠之道mod制作器
{
    public partial class DefenderElementAddBuffForm : Form
    {
        public bool isAdd;
        public DefenderElementAddBuffForm()
        {
            InitializeComponent();
        }
        public DefenderElementAddBuffForm(string tag, bool isAdd, Form owner) : this()
        {
            Owner = owner;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"DefenderElementAddBuff\" : "
                + "\"" + noneIdTextBox.Text + "\", "
                + "\"" + metalIdTextBox.Text + "\", "
                + "\"" + woodIdTextBox.Text + "\", "
                + "\"" + waterIdTextBox.Text + "\", "
