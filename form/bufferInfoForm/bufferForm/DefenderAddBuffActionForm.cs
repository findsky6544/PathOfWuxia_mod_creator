...
namespace 侠之道mod制作器
{
    public partial class DefenderAddBuffActionForm : Form
    {
        public bool isAdd;
        public DefenderAddBuffActionForm()
        {
            InitializeComponent();

            initTypeComboBox();
        }
        public DefenderAddBuffActionForm(string tag, bool isAdd, Form owner) : this()
        {
            Owner = owner;
