...
namespace 侠之道mod制作器
{
    public partial class AttackerRandomClearBuffActionForm : Form
    {
        public bool isAdd;
        public AttackerRandomClearBuffActionForm()
        {
            InitializeComponent();

            initOrientedComboBox();
        }
        public AttackerRandomClearBuffActionForm(string tag, bool isAdd, Form owner) : this()
        {
            Owner = owner;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"AttackerRandomClearBuffAction\" : " + ((ComboBoxItem)orientedComboBox.SelectedItem).key + ", " + countNumericUpDown.Value;

            currentNode.Text = "随机清除攻击者Buff:" + orientedComboBox.Text + " " + countNumericUpDown.Value + " 个";
            Close();
        }
