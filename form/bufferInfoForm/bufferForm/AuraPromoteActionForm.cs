...
namespace 侠之道mod制作器
{
    public partial class AuraPromoteActionForm : Form
    {
        public bool isAdd;
        public AuraPromoteActionForm()
        {
            InitializeComponent();
        ...
        public AuraPromoteActionForm(string tag, bool isAdd, Form owner) : this()
        {
            Owner = owner;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"AuraPromoteAction\" : " + ((ComboBoxItem)unitFactionComboBox.SelectedItem).key
            ...
            currentNode.Text = "条件式范围增加Buff(持续性):" + "距离 " + distanceNumericUpDown.Value + " 格内的 " + unitFactionComboBox.Text
