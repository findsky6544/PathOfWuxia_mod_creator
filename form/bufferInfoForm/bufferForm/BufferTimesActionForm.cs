...
namespace 侠之道mod制作器
{
    public partial class BufferTimesActionForm : Form
    {
        public bool isAdd;
        public BufferTimesActionForm()
        {
            InitializeComponent();

            initMethodComboBox();
        }
        public BufferTimesActionForm(string tag, bool isAdd, Form owner) : this()
        {
            Owner = owner;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"BufferTimesAction\" : " + ((ComboBoxItem)methodComboBox.SelectedItem).key + ", " + int.Parse(valueNumericUpDown.Text);
            ...
            currentNode.Text = "增益次数:" + bufferStr;
            Close();
        }
