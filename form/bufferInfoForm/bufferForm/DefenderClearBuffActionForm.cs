...
namespace 侠之道mod制作器
{
    public partial class DefenderClearBuffActionForm : Form
    {
        public bool isAdd;
        public DefenderClearBuffActionForm()
        {
            InitializeComponent();
        }
        public DefenderClearBuffActionForm(string tag, bool isAdd, Form owner) : this()
        {
            Owner = owner;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"DefenderClearBuffAction\" : \"" + bufferIdTextBox.Text + "\"";
            currentNode.Text = "指定清除防御者Buff: " + DataManager.getBuffersName(bufferIdTextBox.Text);
            Close();
        }
