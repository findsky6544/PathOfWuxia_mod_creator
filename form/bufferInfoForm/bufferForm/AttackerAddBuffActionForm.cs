...
namespace 侠之道mod制作器
{
    public partial class AttackerAddBuffActionForm : Form
    {
        public bool isAdd;
        public AttackerAddBuffActionForm()
        {
            InitializeComponent();

            initTypeComboBox();
        }
        public AttackerAddBuffActionForm(string tag, bool isAdd, Form owner) : this()
        {
            Owner = owner;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"AttackerAddBuffAction\" : \"" + bufferIdTextBox.Text + "\", " + countNumericUpDown.Value + ", " + ((ComboBoxItem)typeComboBox.SelectedItem).key;
