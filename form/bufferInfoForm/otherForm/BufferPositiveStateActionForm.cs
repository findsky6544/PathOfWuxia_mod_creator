...
namespace 侠之道mod制作器
{
    public partial class BufferPositiveStateActionForm : Form
    {
        public bool isAdd;
        public BufferPositiveStateActionForm()
        {
            InitializeComponent();

            initStatusComboBox();
        }
        public BufferPositiveStateActionForm(string tag, bool isAdd, Form owner) : this()
        {
            Owner = owner;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"BufferPositiveStateAction\" : " + ((ComboBoxItem)StausComboBox.SelectedItem).key;



            currentNode.Text = "赋予正面状态（叠加类型）:" + StausComboBox.Text;
            Close();
        }
