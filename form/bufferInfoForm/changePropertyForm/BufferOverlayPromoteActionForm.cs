...
namespace 侠之道mod制作器
{
    public partial class BufferOverlayPromoteActionForm : Form
    {
        public bool isAdd;
        public BufferOverlayPromoteActionForm()
        {
            InitializeComponent();
        ...
        public BufferOverlayPromoteActionForm(string tag, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            ...
            if (!string.IsNullOrEmpty(fields))
            {
                ...
                bufferIdTextBox.Text = fieldsList[4];
                isTargetCheckBox.Checked = fieldsList[5] == "True";
            }
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(bufferIdTextBox.Text))
            {
            ...
            currentNode.Tag = "\"BufferOverlayPromoteAction\" : " + ((ComboBoxItem)propertyComboBox.SelectedItem).key + ", "
                + ((ComboBoxItem)methodComboBox.SelectedItem).key + ", " + float.Parse(valueNumericUpDown.Text).ToString("0.00000") + ", " + float.Parse(valueLimitNumericUpDown.Text).ToString("0.00000") + ", \"" + bufferIdTextBox.Text + "\", " + isTargetCheckBox.Checked;
            ...
            currentNode.Text = "buffer重数提升属性:" + (isTargetCheckBox.Checked ? "目标" : "自身") + " 每有1重 " + DataManager.getBuffersName(bufferIdTextBox.Text) + " " + bufferStr;
            Close();
        }
