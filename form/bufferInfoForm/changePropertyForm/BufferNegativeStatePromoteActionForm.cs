...
namespace 侠之道mod制作器
{
    public partial class BufferNegativeStatePromoteActionForm : Form
    {
        public bool isAdd;
        public BufferNegativeStatePromoteActionForm()
        {
            InitializeComponent();
        ...
        public BufferNegativeStatePromoteActionForm(string tag, bool isAdd, Form owner) : this()
        {
            Owner = owner;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"BufferNegativeStatePromoteAction\" : " + ((ComboBoxItem)propertyComboBox.SelectedItem).key + ", "
                + ((ComboBoxItem)methodComboBox.SelectedItem).key + ", " + valueNumericUpDown.Text + ", " + valueLimitNumericUpDown.Text + ", " + ((ComboBoxItem)statusComboBox.SelectedItem).key;
            ...
            currentNode.Text = "负面状态重数提升属性:" + "每有1重 " + statusComboBox.Text + " " + bufferStr;
            Close();
        }
