...
namespace 侠之道mod制作器
{
    public partial class NumberOfMovementsPromoteActionForm : Form
    {
        public bool isAdd;
        public NumberOfMovementsPromoteActionForm()
        {
            InitializeComponent();
        ...
        public NumberOfMovementsPromoteActionForm(string tag, bool isAdd, Form owner) : this()
        {
            Owner = owner;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"NumberOfMovementsPromoteAction\" : " + ((ComboBoxItem)propertyComboBox.SelectedItem).key + ", "
            ...
            currentNode.Text = "攻击者剩余移动数提升属性:每1格剩余移动数" + " " + bufferStr;
            Close();
        }
