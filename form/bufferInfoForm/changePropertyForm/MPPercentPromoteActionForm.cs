...
namespace 侠之道mod制作器
{
    public partial class MPPercentPromoteActionForm : Form
    {
        public bool isAdd;
        public MPPercentPromoteActionForm()
        {
            InitializeComponent();
        ...
        public MPPercentPromoteActionForm(string tag, bool isAdd, Form owner) : this()
        {
            Owner = owner;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"MPPercentPromoteAction\" : "
            ...
            currentNode.Text = "MP百分比修改属性:" + bufferStr;
            Close();
        }
