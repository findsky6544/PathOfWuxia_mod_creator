...
namespace 侠之道mod制作器
{
    public partial class BufferDistancePromoteActionForm : Form
    {
        public bool isAdd;
        public BufferDistancePromoteActionForm()
        {
            InitializeComponent();
        ...
        public BufferDistancePromoteActionForm(string tag, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            ...
            if (!string.IsNullOrEmpty(fields))
            {
                ...
                minDisNumericUpDown.Value = int.Parse(fieldsList[4]);
            }
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(minDisNumericUpDown.Text))
            {
                MessageBox.Show("请输入最小格数");
                return;
            }
            ...
            currentNode.Tag = "\"BufferDistancePromoteAction\" : " + ((ComboBoxItem)propertyComboBox.SelectedItem).key + ", "
                + ((ComboBoxItem)methodComboBox.SelectedItem).key + ", " + valueNumericUpDown.Text + ", " + valueLimitNumericUpDown.Text + ", " + minDisNumericUpDown.Value;
            ...
            currentNode.Text = "攻击距离提升属性:" + "超过 " + minDisNumericUpDown.Value + " 格每1格" + " " + bufferStr;
            Close();
        }
