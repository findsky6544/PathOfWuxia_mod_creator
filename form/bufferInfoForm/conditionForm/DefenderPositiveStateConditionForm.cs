...
namespace 侠之道mod制作器
{
    public partial class DefenderPositiveStateConditionForm : Form
    {
        public bool isAdd;
        public DefenderPositiveStateConditionForm()
        {
            InitializeComponent();
        ...
        public DefenderPositiveStateConditionForm(string tag, bool isAdd, Form owner) : this()
        {
            Owner = owner;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"DefenderPositiveStateCondition\" : " + ((ComboBoxItem)opComboBox.SelectedItem).key + ", " + valueNumericUpDown.Value + ", " + ((ComboBoxItem)propertyComboBox.SelectedItem).key;
            currentNode.Text = "判断防御者正面状态:" + propertyComboBox.Text + " " + opComboBox.Text + " " + valueNumericUpDown.Value + " 重";
            Close();
        }
