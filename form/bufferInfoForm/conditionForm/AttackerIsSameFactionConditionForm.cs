...
namespace 侠之道mod制作器
{
    public partial class AttackerIsSameFactionConditionForm : Form
    {
        public bool isAdd;
        public AttackerIsSameFactionConditionForm()
        {
            InitializeComponent();
        }
        public AttackerIsSameFactionConditionForm(string tag, bool isAdd, Form owner) : this()
        {
            Owner = owner;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"AttackerIsSameFactionCondition\" : " + isSameFactionCheckBox.Checked;
            currentNode.Text = "判断攻击者是否同阵营: " + (isSameFactionCheckBox.Checked ? "是" : "否");
            Close();
        }
