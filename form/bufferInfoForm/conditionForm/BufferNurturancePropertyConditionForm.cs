...
namespace 侠之道mod制作器
{
    public partial class BufferNurturancePropertyConditionForm : Form
    {
        public bool isAdd;
        public BufferNurturancePropertyConditionForm()
        {
            InitializeComponent();
        ...
        public BufferNurturancePropertyConditionForm(string tag, bool isAdd, Form owner) : this()
        {
            Owner = owner;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"BufferNurturancePropertyCondition\" : " + ((ComboBoxItem)opComboBox.SelectedItem).key + ", " + valueNumericUpDown.Value + ", " + ((ComboBoxItem)propertyComboBox.SelectedItem).key;
            currentNode.Text = "判断自身养成属性:" + propertyComboBox.Text + " " + opComboBox.Text + " " + valueNumericUpDown.Value;
            Close();
        }
