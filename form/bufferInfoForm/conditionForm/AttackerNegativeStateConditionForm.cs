...
namespace 侠之道mod制作器
{
    public partial class AttackerNegativeStateConditionForm : Form
    {
        public bool isAdd;
        public AttackerNegativeStateConditionForm()
        {
            InitializeComponent();
        ...
        public AttackerNegativeStateConditionForm(string tag, bool isAdd, Form owner) : this()
        {
            Owner = owner;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"AttackerNegativeStateCondition\" : " + ((ComboBoxItem)opComboBox.SelectedItem).key + ", " + valueNumericUpDown.Value + ", " + ((ComboBoxItem)propertyComboBox.SelectedItem).key;
            currentNode.Text = "判断攻击者负面状态:" + propertyComboBox.Text + " " + opComboBox.Text + " " + valueNumericUpDown.Value + " 重";
            Close();
        }
