...
namespace 侠之道mod制作器
{
    public partial class SelfNegativeStateConditionForm : Form
    {
        public bool isAdd;
        public SelfNegativeStateConditionForm()
        {
            InitializeComponent();
        ...
        public SelfNegativeStateConditionForm(string tag, bool isAdd, Form owner) : this()
        {
            Owner = owner;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"SelfNegativeStateCondition\" : " + ((ComboBoxItem)opComboBox.SelectedItem).key + ", " + valueNumericUpDown.Value + ", " + ((ComboBoxItem)propertyComboBox.SelectedItem).key;
            currentNode.Text = "判断自身负面状态:" + propertyComboBox.Text + " " + opComboBox.Text + " " + valueNumericUpDown.Value + " 重";
            Close();
        }
