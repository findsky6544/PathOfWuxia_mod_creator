...
namespace 侠之道mod制作器
{
    public partial class BufferDefenderWeaponTypeConditionForm : Form
    {
        public bool isAdd;
        public BufferDefenderWeaponTypeConditionForm()
        {
            InitializeComponent();

            initFactionComboBox();
        }
        public BufferDefenderWeaponTypeConditionForm(string tag, bool isAdd, Form owner) : this()
        {
            Owner = owner;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"BufferDefenderWeaponTypeCondition\" : " + ((ComboBoxItem)propsCategoryComboBox.SelectedItem).key + ", " + IsReverseCheckBox.Checked;
            currentNode.Text = Text + ": " + (IsReverseCheckBox.Checked ? "不是" : "是") + " " + propsCategoryComboBox.Text;
            Close();
        }
