...
namespace 侠之道mod制作器
{
    public partial class BufferSkillTypeConditionForm : Form
    {
        public bool isAdd;
        public BufferSkillTypeConditionForm()
        {
            InitializeComponent();

            initFactionComboBox();
        }
        public BufferSkillTypeConditionForm(string tag, bool isAdd, Form owner) : this()
        {
            Owner = owner;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"BufferSkillTypeCondition\" : " + ((ComboBoxItem)propsCategoryComboBox.SelectedItem).key + ", " + IsReverseCheckBox.Checked;
