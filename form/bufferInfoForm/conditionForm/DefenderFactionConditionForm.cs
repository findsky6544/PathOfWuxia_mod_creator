...
namespace 侠之道mod制作器
{
    public partial class DefenderFactionConditionForm : Form
    {
        public bool isAdd;
        public DefenderFactionConditionForm()
        {
            InitializeComponent();

            initFactionComboBox();
        }
        public DefenderFactionConditionForm(string tag, bool isAdd, Form owner) : this()
        {
            Owner = owner;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"DefenderFactionCondition\" : " + ((ComboBoxItem)factionComboBox.SelectedItem).key + ", " + IsReverseCheckBox.Checked;
            currentNode.Text = "判断防御者阵营: " + (IsReverseCheckBox.Checked ? "不是" : "是") + " " + factionComboBox.Text;
            Close();
        }
