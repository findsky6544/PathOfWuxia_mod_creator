...
namespace 侠之道mod制作器
{
    public partial class DefenderIDConditionForm : Form
    {
        public bool isAdd;
        public DefenderIDConditionForm()
        {
            InitializeComponent();
        }
        public DefenderIDConditionForm(string tag, bool isAdd, Form owner) : this()
        {
            Owner = owner;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"DefenderIDCondition\" : \"" + unitIdTextBox.Text + "\", " + IsReverseCheckBox.Checked;
            currentNode.Text = "判断防御者ID: " + (IsReverseCheckBox.Checked ? "不是" : "是") + " " + DataManager.getUnitsName(unitIdTextBox.Text);
            Close();
        }
