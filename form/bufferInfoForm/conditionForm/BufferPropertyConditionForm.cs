...
namespace 侠之道mod制作器
{
    public partial class BufferPropertyConditionForm : Form
    {
        public bool isAdd;
        public BufferPropertyConditionForm()
        {
            InitializeComponent();
        ...
        public BufferPropertyConditionForm(string tag, bool isAdd, Form owner) : this()
        {
            Owner = owner;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"BufferPropertyCondition\" : " + ((ComboBoxItem)opComboBox.SelectedItem).key + ", " + valueNumericUpDown.Value + ", " + ((ComboBoxItem)propertyComboBox.SelectedItem).key;
            ...
            currentNode.Text = "判断自身战斗属性:" + propertyComboBox.Text + " " + opComboBox.Text + " " + valueNumericUpDown.Value + percentStr;
            Close();
        }
