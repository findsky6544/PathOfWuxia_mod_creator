...
namespace 侠之道mod制作器
{
    public partial class DefendeHasBufferConditionForm : Form
    {
        public bool isAdd;
        public DefendeHasBufferConditionForm()
        {
            InitializeComponent();
        }
        public DefendeHasBufferConditionForm(string tag, bool isAdd, Form owner) : this()
        {
            Owner = owner;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            currentNode.Tag = "\"DefendeHasBufferCondition\" : \"" + bufferIdTextBox.Text + "\", " + existCheckBox.Checked;
            currentNode.Text = "防御者是否存在指定buff: " + (existCheckBox.Checked ? "存在" : "不存在") + " " + DataManager.getBuffersName(bufferIdTextBox.Text);
            Close();
        }
