...
namespace 侠之道mod制作器
{
    public partial class BattleFactorTargetDestroyForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public BattleFactorTargetDestroyForm()
        {
            InitializeComponent();
        }

        public BattleFactorTargetDestroyForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            lvi.Tag = "\\\"BattleFactorTargetDestroy\\\" : \\\"" + unitIDTextBox.Text + "\\\"";
            lvi.SubItems[1].Text = "判断 " + DataManager.getUnitsName(unitIDTextBox.Text) + " 是否死亡:是";
