...
namespace 侠之道mod制作器
{
    public partial class BattleFactorFactionDefeatForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public BattleFactorFactionDefeatForm()
        {
            InitializeComponent();
            initFactionComboBox();
        }

        public BattleFactorFactionDefeatForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            lvi.Tag = "\\\"BattleFactorFactionDefeat\\\" : " + ((ComboBoxItem)factionComboBox.SelectedItem).key;
            lvi.SubItems[1].Text = "判断 " + factionComboBox.Text + " 是否全灭:是";
