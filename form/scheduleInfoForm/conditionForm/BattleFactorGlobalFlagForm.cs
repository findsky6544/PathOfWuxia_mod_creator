...
namespace 侠之道mod制作器
{
    public partial class BattleFactorGlobalFlagForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public BattleFactorGlobalFlagForm()
        {
            InitializeComponent();
            initOpComboBox();
        }

        public BattleFactorGlobalFlagForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            lvi.Tag = "\\\"BattleFactorGlobalFlag\\\" : " + ((ComboBoxItem)opComboBox.SelectedItem).key + ", " + valueNumericUpDown.Value
