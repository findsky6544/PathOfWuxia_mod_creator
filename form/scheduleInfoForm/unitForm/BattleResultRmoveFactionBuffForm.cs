...
namespace 侠之道mod制作器
{
    public partial class BattleResultRmoveFactionBuffForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public BattleResultRmoveFactionBuffForm()
        {
            InitializeComponent();
            initFactionComboBox();
        }

        public BattleResultRmoveFactionBuffForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            lvi.Tag = "\\\"BattleResultRmoveFactionBuff\\\" : " + ((ComboBoxItem)factionComboBox.SelectedItem).key + ", \\\"" + buffIdTextBox.Text + "\\\"";
            lvi.SubItems[1].Text = Text + ":" + factionComboBox.Text + " 移除增益 " + DataManager.getBuffersName(buffIdTextBox.Text);
