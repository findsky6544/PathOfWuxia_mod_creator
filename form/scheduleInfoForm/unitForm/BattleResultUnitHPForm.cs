...
namespace 侠之道mod制作器
{
    public partial class BattleResultUnitHPForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public BattleResultUnitHPForm()
        {
            InitializeComponent();
            initMethodComboBox();
        }

        public BattleResultUnitHPForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            lvi.Tag = "\\\"BattleResultUnitHP\\\" : " + ((ComboBoxItem)methodComboBox.SelectedItem).key + ", " + valueNumericUpDown.Value
                 + ", \\\"" + unitIDTextBox.Text + "\\\"";
