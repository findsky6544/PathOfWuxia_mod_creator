...
namespace 侠之道mod制作器
{
    public partial class BattleResultRemoveUnitForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public BattleResultRemoveUnitForm()
        {
            InitializeComponent();
        }

        public BattleResultRemoveUnitForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            lvi.Tag = "\\\"BattleResultRemoveUnit\\\" : \\\"" + unitIDTextBox.Text + "\\\", " + IsDeadCheckBox.Checked;
