...
namespace 侠之道mod制作器
{
    public partial class SetLocalFlagBattleActionForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public SetLocalFlagBattleActionForm()
        {
            InitializeComponent();
            initOpComboBox();
        }

        public SetLocalFlagBattleActionForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            lvi.Tag = "\\\"SetLocalFlagBattleAction\\\" : \\\"" + flagNameTextBox.Text + "\\\", " + ((ComboBoxItem)methodComboBox.SelectedItem).key
