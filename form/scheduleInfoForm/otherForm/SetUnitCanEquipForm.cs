...
namespace 侠之道mod制作器
{
    public partial class SetUnitCanEquipForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public SetUnitCanEquipForm()
        {
            InitializeComponent();
        }

        public SetUnitCanEquipForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            lvi.Tag = "\\\"SetUnitCanEquip\\\" : \\\"" + unitIDTextBox.Text + "\\\"" + IsOpenCheckBox.Checked;
