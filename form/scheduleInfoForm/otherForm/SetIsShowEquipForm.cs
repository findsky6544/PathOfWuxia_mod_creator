...
namespace 侠之道mod制作器
{
    public partial class SetIsShowEquipForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public SetIsShowEquipForm()
        {
            InitializeComponent();
        }

        public SetIsShowEquipForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            lvi.Tag = "\\\"SetIsShowEquip\\\" : " + IsOpenCheckBox.Checked;
