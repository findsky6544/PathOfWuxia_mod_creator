...
namespace 侠之道mod制作器
{
    public partial class SetUnitCanUseSpecialSkillForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public SetUnitCanUseSpecialSkillForm()
        {
            InitializeComponent();
        }

        public SetUnitCanUseSpecialSkillForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            lvi.Tag = "\\\"SetUnitCanUseSpecialSkill\\\" : \\\"" + unitIDTextBox.Text + "\\\"" + IsOpenCheckBox.Checked;
