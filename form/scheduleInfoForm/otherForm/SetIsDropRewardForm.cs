...
namespace 侠之道mod制作器
{
    public partial class SetIsDropRewardForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public SetIsDropRewardForm()
        {
            InitializeComponent();
        }

        public SetIsDropRewardForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            lvi.Tag = "\\\"SetIsDropReward\\\" : " + IsOpenCheckBox.Checked;
