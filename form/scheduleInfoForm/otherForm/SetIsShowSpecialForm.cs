...
namespace 侠之道mod制作器
{
    public partial class SetIsShowSpecialForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public SetIsShowSpecialForm()
        {
            InitializeComponent();
        }

        public SetIsShowSpecialForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            lvi.Tag = "\\\"SetIsShowSpecial\\\" : " + IsOpenCheckBox.Checked;
