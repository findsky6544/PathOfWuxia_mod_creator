...
namespace 侠之道mod制作器
{
    public partial class SetIsShowSkillForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public SetIsShowSkillForm()
        {
            InitializeComponent();
        }

        public SetIsShowSkillForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            lvi.Tag = "\\\"SetIsShowSkill\\\" : " + IsOpenCheckBox.Checked;
