...
namespace 侠之道mod制作器
{
    public partial class SetUnitCanUseSkillsForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public SetUnitCanUseSkillsForm()
        {
            InitializeComponent();
        }

        public SetUnitCanUseSkillsForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            lvi.Tag = "\\\"SetUnitCanUseSkills\\\" : \\\"" + unitIDTextBox.Text + "\\\"" + IsOpenCheckBox.Checked;
