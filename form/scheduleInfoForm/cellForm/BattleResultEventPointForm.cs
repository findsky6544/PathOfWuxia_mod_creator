...
namespace 侠之道mod制作器
{
    public partial class BattleResultEventPointForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public BattleResultEventPointForm()
        {
            InitializeComponent();
        }

        public BattleResultEventPointForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            lvi.Tag = "\\\"BattleResultEventPoint\\\" : \\\"" + tileNumbersTextBox.Text + "\\\"";
