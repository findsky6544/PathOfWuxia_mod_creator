...
namespace 侠之道mod制作器
{
    public partial class BattleResultRemoveExitPointForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public BattleResultRemoveExitPointForm()
        {
            InitializeComponent();
        }

        public BattleResultRemoveExitPointForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            lvi.Tag = "\\\"BattleResultRemoveExitPoint\\\" : \\\"" + tileNumbersTextBox.Text + "\\\"";
