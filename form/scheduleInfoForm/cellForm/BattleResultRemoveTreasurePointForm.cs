...
namespace 侠之道mod制作器
{
    public partial class BattleResultRemoveTreasurePointForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public BattleResultRemoveTreasurePointForm()
        {
            InitializeComponent();
        }

        public BattleResultRemoveTreasurePointForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            lvi.Tag = "\\\"BattleResultRemoveTreasurePoint\\\" : \\\"" + tileNumbersTextBox.Text + "\\\"";
