...
namespace 侠之道mod制作器
{
    public partial class BattleResultRemoveEventPointForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public BattleResultRemoveEventPointForm()
        {
            InitializeComponent();
        }

        public BattleResultRemoveEventPointForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
