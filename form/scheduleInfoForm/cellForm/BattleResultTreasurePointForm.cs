...
namespace 侠之道mod制作器
{
    public partial class BattleResultTreasurePointForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public BattleResultTreasurePointForm()
        {
            InitializeComponent();
        }

        public BattleResultTreasurePointForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            lvi.Tag = "\\\"BattleResultTreasurePoint\\\" : \\\"" + tileNumbersTextBox.Text + "\\\"";
