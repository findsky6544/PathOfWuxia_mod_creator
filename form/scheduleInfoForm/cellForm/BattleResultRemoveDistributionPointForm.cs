...
namespace 侠之道mod制作器
{
    public partial class BattleResultRemoveDistributionPointForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public BattleResultRemoveDistributionPointForm()
        {
            InitializeComponent();
        }

        public BattleResultRemoveDistributionPointForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            lvi.Tag = "\\\"BattleResultRemoveDistributionPoint\\\" : \\\"" + tileNumbersTextBox.Text + "\\\"";
