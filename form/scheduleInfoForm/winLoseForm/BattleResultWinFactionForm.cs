...
namespace 侠之道mod制作器
{
    public partial class BattleResultWinFactionForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public BattleResultWinFactionForm()
        {
            InitializeComponent();
            initAitypeComboBox();
        }
        public BattleResultWinFactionForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            lvi.Tag = "\\\"BattleResultWinFaction\\\" : \\\"" + WinLoseIDTextBox.Text + "\\\", " + ((ComboBoxItem)factionComboBox.SelectedItem).key;
