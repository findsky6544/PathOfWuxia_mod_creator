...
namespace 侠之道mod制作器
{
    public partial class BattleResultLoseTurnForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public BattleResultLoseTurnForm()
        {
            InitializeComponent();
        }
        public BattleResultLoseTurnForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            lvi.Tag = "\\\"BattleResultLoseTurn\\\" : \\\"" + WinLoseIDTextBox.Text + "\\\", " + TurnNumericUpDown.Text;
