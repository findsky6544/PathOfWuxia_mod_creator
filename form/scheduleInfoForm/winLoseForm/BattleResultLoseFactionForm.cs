...
namespace 侠之道mod制作器
{
    public partial class BattleResultLoseFactionForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public BattleResultLoseFactionForm()
        {
            InitializeComponent();
            initAitypeComboBox();
        }
        public BattleResultLoseFactionForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            lvi.Tag = "\\\"BattleResultLoseFaction\\\" : \\\"" + WinLoseIDTextBox.Text + "\\\", " + ((ComboBoxItem)factionComboBox.SelectedItem).key;
            lvi.SubItems[1].Text = Text + ":" + (WinLoseIDTextBox.Text == "" ? "" : "id:" + WinLoseIDTextBox.Text) + " " + factionComboBox.Text + " 全灭";
