...
namespace 侠之道mod制作器
{
    public partial class BattleResultWinFactionExitForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public BattleResultWinFactionExitForm()
        {
            InitializeComponent();
            initAitypeComboBox();
        }
        public BattleResultWinFactionExitForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            lvi.Tag = "\\\"BattleResultWinFactionExit\\\" : \\\"" + WinLoseIDTextBox.Text + "\\\", " + ((ComboBoxItem)factionComboBox.SelectedItem).key;
