...
namespace 侠之道mod制作器
{
    public partial class BattleResultWinRemoveForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public BattleResultWinRemoveForm()
        {
            InitializeComponent();
        }
        public BattleResultWinRemoveForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            lvi.Tag = "\\\"BattleResultWinRemove\\\" : \\\"" + WinLoseIDTextBox.Text + "\\\" ";
