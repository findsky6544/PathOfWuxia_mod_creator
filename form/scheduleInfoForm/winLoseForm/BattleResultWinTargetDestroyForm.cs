...
namespace 侠之道mod制作器
{
    public partial class BattleResultWinTargetDestroyForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public BattleResultWinTargetDestroyForm()
        {
            InitializeComponent();
        }
        public BattleResultWinTargetDestroyForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            lvi.Tag = "\\\"BattleResultWinTargetDestroy\\\" : \\\"" + WinLoseIDTextBox.Text + "\\\", " + "\\\"" + targetIDTextBox.Text + "\\\"";
