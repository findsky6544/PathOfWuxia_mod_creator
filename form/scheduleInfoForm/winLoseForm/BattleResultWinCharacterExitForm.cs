...
namespace 侠之道mod制作器
{
    public partial class BattleResultWinCharacterExitForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public BattleResultWinCharacterExitForm()
        {
            InitializeComponent();
        }
        public BattleResultWinCharacterExitForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            lvi.Tag = "\\\"BattleResultWinCharacterExit\\\" : \\\"" + WinLoseIDTextBox.Text + "\\\", " + "\\\"" + targetIDTextBox.Text + "\\\"";
