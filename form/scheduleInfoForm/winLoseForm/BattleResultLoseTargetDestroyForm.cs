...
namespace 侠之道mod制作器
{
    public partial class BattleResultLoseTargetDestroyForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public BattleResultLoseTargetDestroyForm()
        {
            InitializeComponent();
        }
        public BattleResultLoseTargetDestroyForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            lvi.Tag = "\\\"BattleResultLoseTargetDestroy\\\" : \\\"" + WinLoseIDTextBox.Text + "\\\", " + "\\\"" + targetIDTextBox.Text + "\\\"";
            lvi.SubItems[1].Text = Text + ":" + (WinLoseIDTextBox.Text == "" ? "" : "id:" + WinLoseIDTextBox.Text) + " " + DataManager.getUnitsName(targetIDTextBox.Text) + " 死亡";
