...
namespace 侠之道mod制作器
{
    public partial class BattleResultWinForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public BattleResultWinForm()
        {
            InitializeComponent();
        }
        public BattleResultWinForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
