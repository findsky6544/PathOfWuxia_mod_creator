...
namespace 侠之道mod制作器
{
    public partial class StepByStepNodeForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public StepByStepNodeForm()
        {
            InitializeComponent();
        }
        public StepByStepNodeForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
