...
namespace 侠之道mod制作器
{
    public partial class ExecuteOnceNodeForm : Form
    {
        public bool isAdd;
        ListViewItem lvi = null;
        public ExecuteOnceNodeForm()
        {
            InitializeComponent();
        }
        public ExecuteOnceNodeForm(ListViewItem lvi, bool isAdd, Form owner) : this()
        {
            Owner = owner;
            this.lvi = lvi;
